      ...
      <Router>
        ...
        <div className="App">
          <Routes>
            ...
            <Route
              path="/teorie/contrastul-in-web-design"
              element={<ContrastulInWebDesign />}
            />
            <Route
              path="/teorie/contrastul-in-arta"
              element={<ContrastulInArta />}
            />
            <Route
              path="/teorie/durabilitatea"
              element={<DurabilitateaCulorilor />}
            />
            <Route
              path="/teorie/sustenabilitatea"
              element={<Sustenabilitatea />}
            />
